...
| 文件路径 | 代码行数 | 主要功能 |
|---------|---------|---------|
| `src/evaluation/zero_shot_benchmark.py` | ~2100行 | 核心评测类 |
| `scripts/run_zero_shot_benchmark.py` | ~600行 | 命令行工具 |
| `examples/zero_shot_benchmark_example.py` | ~600行 | 使用示例 |
| `demo_zero_shot.py` | ~200行 | 演示脚本 |
...
| 文件路径 | 行数 | 主要内容 |
|---------|------|---------|
| `ZERO_SHOT_BENCHMARK_README.md` | ~800行 | 完整使用文档 |
| `ZERO_SHOT_BENCHMARK_SUMMARY.md` | ~400行 | 功能概览 |
| `QUICK_START.md` | ~400行 | 快速开始指南 |
| `DELIVERY_CONFIRMATION.md` | ~600行 | 交付确认书 |
| `PROJECT_COMPLETION_REPORT.md` | ~300行 | 项目完成报告 |
